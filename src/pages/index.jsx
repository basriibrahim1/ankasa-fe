    ...
    <Layout>
        ...
        <div className='mt-24 h-2/6'>
            <div className='flex justify-between w-full items-center'>
                ...
                <Image src={tokyo} width={400} height={300} style={{objectFit:'contain'}}/>
            </div>
            <div className='justify-between flex'>
                <Image src={jpn} height={300} width={800} style={{objectFit:'contain'}} className='rounded-xl'/>
                <Image src={circle} height={150} width={200} style={{transform:'rotate(2deg)'}} className='me-40 mt-72'/>
            </div>
            ...
            <div className='px-40 mt-20'>
                ...
                <div className='bg-blue-400 rounded-3xl px-40 items-center justify-center flex flex-col space-y-7 mt-10'>
